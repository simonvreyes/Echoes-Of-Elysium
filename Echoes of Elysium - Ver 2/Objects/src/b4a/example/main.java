...
int _answ = 0;
 //BA.debugLineNum = 47;BA.debugLine="Private Sub Activity_KeyPress (KeyCode As Int) As";
 //BA.debugLineNum = 48;BA.debugLine="Dim answ As Int";
_answ = 0;
 //BA.debugLineNum = 49;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 50;BA.debugLine="answ = Msgbox2(\"Are you sure you want to quit?\",";
_answ = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("Are you sure you want to quit?"),BA.ObjectToCharSequence("WARNING"),"Yes","","No",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
 //BA.debugLineNum = 51;BA.debugLine="If answ = DialogResponse.POSITIVE Then";
