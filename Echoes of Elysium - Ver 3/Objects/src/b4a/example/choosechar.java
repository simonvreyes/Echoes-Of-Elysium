...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 33;BA.debugLine="Activity.LoadLayout(\"chooseCharLayout\")";
mostCurrent._activity.LoadLayout("chooseCharLayout",mostCurrent.activityBA);
 //BA.debugLineNum = 34;BA.debugLine="thKnight.AddTab(\"Background\", \"knightBGLayout.bal";
mostCurrent._thknight.AddTab(mostCurrent.activityBA,"Background","knightBGLayout.bal");
 //BA.debugLineNum = 35;BA.debugLine="thKnight.AddTab(\"Stats\", \"knightStatsLayout.bal\")";
mostCurrent._thknight.AddTab(mostCurrent.activityBA,"Stats","knightStatsLayout.bal");
 //BA.debugLineNum = 37;BA.debugLine="thMage.AddTab(\"Background\", \"mageBGLayout.bal\")";
mostCurrent._thmage.AddTab(mostCurrent.activityBA,"Background","mageBGLayout.bal");
 //BA.debugLineNum = 38;BA.debugLine="thMage.AddTab(\"Stats\", \"mageStatsLayout.bal\")";
mostCurrent._thmage.AddTab(mostCurrent.activityBA,"Stats","mageStatsLayout.bal");
 //BA.debugLineNum = 40;BA.debugLine="thArcher.AddTab(\"Background\", \"archerBGLayout.bal";
mostCurrent._tharcher.AddTab(mostCurrent.activityBA,"Background","archerBGLayout.bal");
 //BA.debugLineNum = 41;BA.debugLine="thArcher.AddTab(\"Stats\", \"archerStatsLayout.bal\")";
...
public static String  _btnnext_click() throws Exception{
 //BA.debugLineNum = 83;BA.debugLine="Private Sub btnNext_Click";
 //BA.debugLineNum = 84;BA.debugLine="Select Case intPanel";
switch (_intpanel) {
case 0: {
 //BA.debugLineNum = 86;BA.debugLine="pnlKnight.SetLayoutAnimated(375,-100%x,pnlKnigh";
mostCurrent._pnlknight.SetLayoutAnimated((int) (375),(int) (-anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)),mostCurrent._pnlknight.getTop(),mostCurrent._pnlknight.getWidth(),mostCurrent._pnlknight.getHeight());
 //BA.debugLineNum = 87;BA.debugLine="pnlMage.SetLayoutAnimated(375,0,pnlMage.Top,pnl";
mostCurrent._pnlmage.SetLayoutAnimated((int) (375),(int) (0),mostCurrent._pnlmage.getTop(),mostCurrent._pnlmage.getWidth(),mostCurrent._pnlmage.getHeight());
 //BA.debugLineNum = 88;BA.debugLine="intPanel = intPanel + 1";
_intpanel = (int) (_intpanel+1);
 //BA.debugLineNum = 89;BA.debugLine="selectedChar = \"Mage\"";
mostCurrent._selectedchar = "Mage";
 break; }
case 1: {
 //BA.debugLineNum = 91;BA.debugLine="pnlMage.SetLayoutAnimated(375,-100%x,pnlMage.To";
mostCurrent._pnlmage.SetLayoutAnimated((int) (375),(int) (-anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)),mostCurrent._pnlmage.getTop(),mostCurrent._pnlmage.getWidth(),mostCurrent._pnlmage.getHeight());
 //BA.debugLineNum = 92;BA.debugLine="pnlArcher.SetLayoutAnimated(375,0,pnlArcher.Top";
mostCurrent._pnlarcher.SetLayoutAnimated((int) (375),(int) (0),mostCurrent._pnlarcher.getTop(),mostCurrent._pnlarcher.getWidth(),mostCurrent._pnlarcher.getHeight());
 //BA.debugLineNum = 93;BA.debugLine="intPanel = intPanel + 1";
_intpanel = (int) (_intpanel+1);
 //BA.debugLineNum = 94;BA.debugLine="selectedChar = \"Archer\"";
mostCurrent._selectedchar = "Archer";
 break; }
case 2: {
 //BA.debugLineNum = 96;BA.debugLine="ToastMessageShow(\"No more characters\",False)";
...
public static String  _btnprev_click() throws Exception{
 //BA.debugLineNum = 65;BA.debugLine="Private Sub btnPrev_Click";
 //BA.debugLineNum = 66;BA.debugLine="Select Case intPanel";
switch (_intpanel) {
case 0: {
 //BA.debugLineNum = 68;BA.debugLine="ToastMessageShow(\"No more characters\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("No more characters"),anywheresoftware.b4a.keywords.Common.False);
 break; }
case 1: {
 //BA.debugLineNum = 71;BA.debugLine="pnlMage.SetLayoutAnimated(375,100%x,pnlMage.Top";
mostCurrent._pnlmage.SetLayoutAnimated((int) (375),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),mostCurrent._pnlmage.getTop(),mostCurrent._pnlmage.getWidth(),mostCurrent._pnlmage.getHeight());
 //BA.debugLineNum = 72;BA.debugLine="pnlKnight.SetLayoutAnimated(375,0,pnlKnight.Top";
mostCurrent._pnlknight.SetLayoutAnimated((int) (375),(int) (0),mostCurrent._pnlknight.getTop(),mostCurrent._pnlknight.getWidth(),mostCurrent._pnlknight.getHeight());
 //BA.debugLineNum = 73;BA.debugLine="intPanel = intPanel - 1";
_intpanel = (int) (_intpanel-1);
 //BA.debugLineNum = 74;BA.debugLine="selectedChar = \"Knight\"";
mostCurrent._selectedchar = "Knight";
 break; }
case 2: {
 //BA.debugLineNum = 76;BA.debugLine="pnlArcher.SetLayoutAnimated(375,100%x,pnlArcher";
mostCurrent._pnlarcher.SetLayoutAnimated((int) (375),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),mostCurrent._pnlarcher.getTop(),mostCurrent._pnlarcher.getWidth(),mostCurrent._pnlarcher.getHeight());
 //BA.debugLineNum = 77;BA.debugLine="pnlMage.SetLayoutAnimated(375,0,pnlMage.Top,pnl";
mostCurrent._pnlmage.SetLayoutAnimated((int) (375),(int) (0),mostCurrent._pnlmage.getTop(),mostCurrent._pnlmage.getWidth(),mostCurrent._pnlmage.getHeight());
 //BA.debugLineNum = 78;BA.debugLine="intPanel = intPanel - 1";
_intpanel = (int) (_intpanel-1);
 //BA.debugLineNum = 79;BA.debugLine="selectedChar = \"Mage\"";
mostCurrent._selectedchar = "Mage";
 break; }
}
;
...
String _ans = "";
 //BA.debugLineNum = 100;BA.debugLine="Sub enterName";
 //BA.debugLineNum = 101;BA.debugLine="Dim ans As String";
_ans = "";
 //BA.debugLineNum = 103;BA.debugLine="strDLG.InputType = strDLG.INPUT_TYPE_TEXT";
mostCurrent._strdlg.setInputType(mostCurrent._strdlg.INPUT_TYPE_TEXT);
 //BA.debugLineNum = 105;BA.debugLine="ans = strDLG.Show(\"Enter Your Name\",selectedChar,";
_ans = BA.NumberToString(mostCurrent._strdlg.Show("Enter Your Name",mostCurrent._selectedchar,"Confirm","Cancel","",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 106;BA.debugLine="If ans = DialogResponse.POSITIVE Then";
if ((_ans).equals(BA.NumberToString(anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE))) { 
 //BA.debugLineNum = 107;BA.debugLine="characterName = strDLG.Input";
_charactername = mostCurrent._strdlg.getInput();
 //BA.debugLineNum = 108;BA.debugLine="StartActivity(FirstArea)";
...
mostCurrent._btnprev = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 14;BA.debugLine="Private ivArcher As ImageView";
mostCurrent._ivarcher = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 15;BA.debugLine="Private ivMage As ImageView";
mostCurrent._ivmage = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 16;BA.debugLine="Private ivKnight As ImageView";
mostCurrent._ivknight = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private thKnight As TabHost";
mostCurrent._thknight = new anywheresoftware.b4a.objects.TabHostWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Private thMage As TabHost";
mostCurrent._thmage = new anywheresoftware.b4a.objects.TabHostWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private thArcher As TabHost";
mostCurrent._tharcher = new anywheresoftware.b4a.objects.TabHostWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Private pnlArcher As Panel";
mostCurrent._pnlarcher = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Private pnlMage As Panel";
mostCurrent._pnlmage = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Private pnlKnight As Panel";
mostCurrent._pnlknight = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Dim intPanel As Int = 0";
_intpanel = (int) (0);
 //BA.debugLineNum = 27;BA.debugLine="Dim strDLG As InputDialog";
mostCurrent._strdlg = new anywheresoftware.b4a.agraham.dialogs.InputDialog();
 //BA.debugLineNum = 28;BA.debugLine="Dim selectedChar As String = \"Knight\"";
mostCurrent._selectedchar = "Knight";
 //BA.debugLineNum = 30;BA.debugLine="End Sub";
return "";
}
public static String  _ivarcher_click() throws Exception{
 //BA.debugLineNum = 61;BA.debugLine="Private Sub ivArcher_Click";
 //BA.debugLineNum = 62;BA.debugLine="enterName";
_entername();
 //BA.debugLineNum = 63;BA.debugLine="End Sub";
return "";
}
public static String  _ivknight_click() throws Exception{
 //BA.debugLineNum = 53;BA.debugLine="Private Sub ivKnight_Click";
 //BA.debugLineNum = 54;BA.debugLine="enterName";
_entername();
 //BA.debugLineNum = 55;BA.debugLine="End Sub";
return "";
}
public static String  _ivmage_click() throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Private Sub ivMage_Click";
 //BA.debugLineNum = 58;BA.debugLine="enterName";
_entername();
