...
Sub Globals
	...
	Private lblDialogue5 As Label
	Private lblDialogue6 As Label
	Private lblDialogue7_1 As Label
	Private lblDialogue7_2 As Label
	...
	Private pnlDialogue5 As Panel
	Private pnlDialogue6 As Panel
	Private pnlChoices As Panel
	Private pnlDialogue7_1 As Panel
	Private pnlDialogue7_2 As Panel
...
Sub Activity_Create(FirstTime As Boolean)
	...
	pnlDialogue5.Visible = False
	pnlDialogue6.Visible = False
	pnlChoices.Visible = False
	pnlDialogue7_1.Visible = False
	pnlDialogue7_2.Visible = False
	...
	If Action = Activity.ACTION_DOWN Then
		...
		Else
			Select Case currentDialogue
				...
				Case 3
					currentLabel = lblDialogue5
					currentDisplayText = displayText5
					currentDialogue = currentDialogue + 1
					pnlDialogue4.Visible = False
					pnlDialogue5.Visible = True
				Case 4
					currentLabel = lblDialogue6
					currentDisplayText = displayText6
					currentDialogue = currentDialogue + 1
					pnlDialogue5.Visible = False
					pnlDialogue6.Visible = True
				Case 5
...
Private Sub btnRiddle_Click
	currentLabel = lblDialogue7_1
	currentDisplayText = displayText7_1
	pnlDialogue6.Visible = False
	pnlChoices.Visible = False
	pnlDialogue7_1.Visible = True
...
Private Sub btnCryptogram_Click
	currentLabel = lblDialogue7_2
	currentDisplayText = displayText7_2
	currentDialogue = currentDialogue + 1
	pnlDialogue6.Visible = False
	pnlChoices.Visible = False
	pnlDialogue7_2.Visible = True
