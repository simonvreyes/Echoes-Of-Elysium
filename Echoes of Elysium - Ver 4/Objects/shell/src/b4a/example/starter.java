...
public static b4a.example.firstareadialogue _firstareadialogue = null;
  public Object[] GetGlobals() {
		return new Object[] {"chooseChar",Debug.moduleToString(b4a.example.choosechar.class),"FirstArea",Debug.moduleToString(b4a.example.firstarea.class),"FirstAreaDialogue",Debug.moduleToString(b4a.example.firstareadialogue.class),"Main",Debug.moduleToString(b4a.example.main.class),"Service",starter.mostCurrent._service,"story",Debug.moduleToString(b4a.example.story.class),"Title",Debug.moduleToString(b4a.example.title.class),"vlPrompt",Debug.moduleToString(b4a.example.vlprompt.class)};
}
}