...
try {
		Debug.PushSubsStack("Activity_Create (vlprompt) ","vlprompt",3,vlprompt.mostCurrent.activityBA,vlprompt.mostCurrent,14);
...
try {
		Debug.PushSubsStack("Activity_Pause (vlprompt) ","vlprompt",3,vlprompt.mostCurrent.activityBA,vlprompt.mostCurrent,25);
...
try {
		Debug.PushSubsStack("Activity_Resume (vlprompt) ","vlprompt",3,vlprompt.mostCurrent.activityBA,vlprompt.mostCurrent,21);
