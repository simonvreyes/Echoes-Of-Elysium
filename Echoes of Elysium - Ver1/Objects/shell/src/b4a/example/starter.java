...
public static b4a.example.choosechar _choosechar = null;
  public Object[] GetGlobals() {
		return new Object[] {"chooseChar",Debug.moduleToString(b4a.example.choosechar.class),"Main",Debug.moduleToString(b4a.example.main.class),"Service",starter.mostCurrent._service,"story",Debug.moduleToString(b4a.example.story.class),"vlPrompt",Debug.moduleToString(b4a.example.vlprompt.class)};
}
}