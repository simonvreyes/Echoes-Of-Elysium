...
public static b4a.example.story _story = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",choosechar.mostCurrent._activity,"Main",Debug.moduleToString(b4a.example.main.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"story",Debug.moduleToString(b4a.example.story.class),"vlPrompt",Debug.moduleToString(b4a.example.vlprompt.class)};
}
}